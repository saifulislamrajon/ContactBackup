...
public class FragmentSent extends Fragment {
    final int REQUEST_MESSAGE_SENT = 1;
    ListView listView4;
    List<Sms> smsList;
...
//        return super.onCreateView(inflater, container, savedInstanceState);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listView4 = getActivity().findViewById(R.id.listView4);
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(getActivity(), android.Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(getActivity(), new String[]{android.Manifest.permission.READ_SMS}, REQUEST_MESSAGE_SENT);
            } else {
                showSms();
            }
        }
...
//            smsList.add("Number: " + Number + "\n" + "Body: " + Body);
        ...
        SmsList adapter = new SmsList(getActivity(), smsList);
